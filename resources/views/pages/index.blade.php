<x-base-layout>
    ...
    <div class="row gy-5 g-xl-8">
        ...
        <!--begin::Col-->
        <div class="col-xxl-8">
            {{ theme()->getView('partials/widgets/charts/_widget-1', array('class' => 'card-xxl-stretch-50 mb-5 mb-xl-8', 'chartColor' => 'primary', 'chartHeight' => '175px')) }}

            {{ theme()->getView('partials/widgets/charts/_widget-2', array('class' => 'card-xxl-stretch-50 mb-5 mb-xl-8', 'chartColor' => 'primary', 'chartHeight' => '175px')) }}
        </div>
        <!--end::Col-->
    </div>
    <!--end::Row-->
