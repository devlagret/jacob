...
class AcctSavingsCashMutationController extends Controller
{
    ...
    public function printNote($savings_cash_mutation_id){
        ...
        $acctsavingscashmutation	= AcctSavingsCashMutation::select('acct_savings_cash_mutation.savings_cash_mutation_id', 'acct_savings_cash_mutation.savings_account_id', 'acct_savings_account.savings_account_no', 'acct_savings_cash_mutation.savings_id', 'acct_savings.savings_name', 'acct_savings_cash_mutation.mutation_id', 'acct_mutation.mutation_name', 'acct_savings_cash_mutation.member_id', 'core_member.member_name', 'core_member.member_address', 'core_member.city_id', 'core_member.kecamatan_id', 'acct_savings_cash_mutation.branch_id', 'core_branch.branch_city',  'core_member.identity_id', 'core_member.member_identity_no', 'acct_savings_cash_mutation.savings_cash_mutation_date', 'acct_savings_cash_mutation.savings_cash_mutation_amount', 'acct_savings_cash_mutation.savings_cash_mutation_amount_adm', 'acct_savings_cash_mutation.savings_cash_mutation_opening_balance', 'acct_savings_cash_mutation.savings_cash_mutation_last_balance', 'acct_savings_cash_mutation.voided_remark', 'acct_savings_cash_mutation.validation', 'acct_savings_cash_mutation.validation_at', 'acct_savings_cash_mutation.validation_id')
        ...
        <table cellspacing=\"0\" cellpadding=\"1\" border=\"0\">
            <tr>
                <td width=\"25%\"></td>
                <td width=\"75%\"><div style=\"text-align: left; font-size:14px\">BUKTI ".$keterangan."</div></td>
            </tr>
            <tr>
                <td width=\"25%\"></td>
        ...
        <table cellspacing=\"0\" cellpadding=\"1\" border=\"0\" width=\"100%\">
            ...
            <tr>
                ...
                <td width=\"80%\"><div style=\"text-align: left;\">: ".Configuration::numtotxt($acctsavingscashmutation['savings_cash_mutation_amount'])."</div></td>
            </tr>
            <tr>
